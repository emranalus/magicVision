...
bgr = cv2.imread("BlueShow.jpeg") # I forgot the Blue one with 3 channels so I use my stupidity to my advantage and used it to reconstruct the 3 channels image :)
...
# In this part I just insert every single grayscale image into the 3 channels image and from 3 grayscale image I generated a 1 BGR image
bgr[:,:,0] = blue
bgr[:,:,1] = green
bgr[:,:,2] = red
